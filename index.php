...
<body class="index_page">
  ...
  <main class="main">
          ...
          <div class="col-7 text-center d-flex justify-content-center align-items-center">
            <div class="abouttext p-4 text-light" style="font-size: 20px;">
              <span>GENERAL IDEA</span> is a brand with</br>
                ...
                sensibility for a modern street mood</br>
                in a place where street and high-end</br>
                meet in the overall atmosphere of</br>
                a subculture, overall presenting </br>
    ...
    <section class="items light-background" style="display: block;">
      ...
      <h1 class="text-center mt-5 text-decoration-underline" style="font-size: 25px;">HEY LADIES, WHAT DO YOU NEED ?</h1>
