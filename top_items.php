              ...
              <div class="col-8 text-center">
                ...
                <div class="mb-3 row ps-4">
                  ...
                  <div class="mb-3 row g-3">
                    <div class="col-sm-7" id="outputt"></div>
                    <div class="col-sm-2" id="jml" style="display: none;">
                      <input type="number" id="pilih" class="form-control form-control-sm">
                    </div>
                    <div class="col-sm-3" id="outputs"></div>
                  </div>
                  <div class="text-start">Total : $<span id="subtotal">0</span></div>
                  <hr>
