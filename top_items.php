    ...
    <div class="container">
      <div class="row g-5">
        ...
        <div class="col-3 text-center">
          <img id="top_1" judul="Eco-leather pintuck [BROWN]" harga="$49" class="img-fluid" src="assets/img/TOP 1.jpg">
        </div>
        <div class="col-3 text-center">
          <img id="top_2" judul="pintuck [BROWN]" harga="$30" class="img-fluid" src="assets/img/TOP 2.jpg">
        </div>
        <div class="col-3 text-center">
          <img id="top_3" judul="Eco-leather pintuck [BROWN]" harga="$49" class="img-fluid" src="assets/img/TOP 3.jpg">
        </div>
        <div class="col-3 text-center">
          <img id="top_4" judul="pintuck [BROWN]" harga="$30" class="img-fluid" src="assets/img/TOP 4.jpg">
        </div>
        <div class="col-3 text-center">
          <img id="top_5" judul="Eco-leather pintuck [BROWN]" harga="$49" class="img-fluid" src="assets/img/TOP 5.jpg">
        </div>
        <div class="col-3 text-center">
          <img id="top_6" judul="pintuck [BROWN]" harga="$30" class="img-fluid" src="assets/img/TOP 6.jpg">
        </div>
